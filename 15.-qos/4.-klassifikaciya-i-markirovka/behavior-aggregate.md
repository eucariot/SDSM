...
> Я намеренно не говорю о том, какие значения какой именно класс трафика описывают, поскольку здесь нет стандартов и формально их можно использовать по своему усмотрению. [Ниже](rekomendacii-ietf-kategorii-trafika-klassy-servisa-i-modeli-povedeniya.md) я расскажу, какие классы и соответствующие им значения рекомендованы.
...
ECN является одним из механизмов предотвращения перегрузок, о которых [ниже](../7.-upravlenie-peregruzkami-congestion-management/).
{% endhint %}
