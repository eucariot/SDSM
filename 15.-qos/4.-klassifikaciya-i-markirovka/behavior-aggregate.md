...
Однако обратную совместимость с IP Precedence сохранили, чтобы устройства, не поддерживающие DS, всё же могли обработывать пакеты согласно приоритетам. Так именно первые три бита DSCP стали описывать Class Selector.

![](../../.gitbook/assets/image%20%2828%29.png)

  
Три бита означает, что DSCP позволяет определить восемь классов трафика. Чем выше значение Class Selector, тем выше уровень сервиса.  
Оставшиеся три бита DSCP используются для указания приоритета отбрасывания пакета \(**Drop Precedence** или **Packet Loss Priority — PLP**\).  
...
>
> {% page-ref page="rekomendacii-ietf-kategorii-trafika-klassy-servisa-i-modeli-povedeniya.md" %}
...
Цель благая, но применения в жизни ECN практически не нашёл. Хотя многие реализации хостовых ОС имеют его поддержку, она выключена.  
  
ECN является одним из механизмов предотвращения перегрузок, о которых [ниже](http://linkmeup.ru/uploads/sdsm-15-qos.html#AVOIDANCE).
{% endhint %}
...
[pcapng](https://yadi.sk/d/qunzFzOZ3YkE3W)  
...
[Подробнее](https://www.tucny.com/Home/dscp-tos)
...
[pcapng](https://yadi.sk/d/dCu1DUFS3YkEA3)  
...
[Файл конфигурации DSCP классификации.](https://docs.google.com/document/d/e/2PACX-1vTrtK-fnUH8KO8UjTlScnv4xT-5FAsp7mDITqtDjtFHDZXJYg4UPvQnhQ5B9JqydfNuY_1-Ho9_RjIH/pub)
...
[Файл конфигурации тот же.](https://docs.google.com/document/d/e/2PACX-1vTrtK-fnUH8KO8UjTlScnv4xT-5FAsp7mDITqtDjtFHDZXJYg4UPvQnhQ5B9JqydfNuY_1-Ho9_RjIH/pub)  
...
[pcapng](https://yadi.sk/d/CN3OUB8y3Ykb3o)  
